...
#define USER_EMAIL    "mujigandrung@gmail.com"
...
void connectFirebase()
{
    ...
    // Tunggu sebentar agar token tersedia
    ...
    if (Firebase.ready())
    {
        Serial.print("Firebase SIAP, UID: ");
        Serial.println(auth.token.uid.c_str());
    }
    else
    {
        Serial.println("Firebase belum mendapatkan token");
    }
}
