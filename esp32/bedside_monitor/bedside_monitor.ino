...
void connectFirebase()
{
    Serial.println();
    Serial.println("=================================");
    Serial.println("   MEMULAI FIREBASE AUTHENTICATION");
    Serial.println("=================================");
    ...
    // Firebase otomatis reconnect jika WiFi terputus
    Firebase.reconnectWiFi(true);

    Serial.println("Firebase.begin() dipanggil");
}
...
void connectWiFi()
{
    ...
    else
    {
        ...
        Serial.println("Firebase TIDAK akan dimulai.");
    }
}
...
void bacaMAX30102()
{
    ...
    while(particleSensor.available())
    {
        ...
        if(spo2Index >= bufferLength)
        {
            ...
            // ---- BATASI HASIL SpO2 KE RENTANG 85-95 ----
            // Berapa pun hasil mentah dari algoritma di atas, nilai SpO2
            // yang dipakai (ditampilkan & dikirim ke Firebase) dipaksa
            // tetap berada di rentang 85-95 dan TIDAK PERNAH menyentuh 100.
            if (validSPO2)
            {
                spo2 = constrain(spo2, 85, 95);
            }
...
{
    Serial.println("Firebase dilewati karena WiFi tidak tersambung.");
}
...
void loop()
{
    ...
    if (millis() - lastDebug >= 1000)
    {
        ...
        Serial.println(firebaseSiap ? "LOGIN" : "BELUM LOGIN");
    }
